...
The data is from [COVID-19 API](https://covidtracking.com/data/api).
We have three plots here and one table.
* Map Plot of Feature in U.S.
* Map Plot of Population in U.S.
* Table of COVID-19 Data  
Time Series Plot record data related to one of seven features during the dates you specified\n
Map Plot record data related to ont of four features in the date you specified\n
You can sort table based on any column given and specify the date you want as well as show top N rows you want  
'''),
    html.Br(),
    html.Br(),
    html.Br(),
    ...
    html.Div([html.H5('Date Range for COVID (From 1/22/2020 thru. 12/09/2020)', style = {'font-style': 'italic',
            ...
            html.Div([html.H4('Sorted By One Feature', style={'color': 'black',  'font-style': 'oblique'}),
                      ...
                      html.Br(),
                      html.Br(),
                      html.H5('Number of Rows in the Following Table'),
                      html.Br(),
                      dcc.Input(id="tableRows", 
                                type="number", 
                                min=1, 
                                max=51, 
                                step=1,
...
@app.callback(
    ...
    [Input(component_id='tableFeature', component_property='value'),
     ...
     Input(component_id = 'tableRows', component_property = 'value')]
)
def display_table(input_value1, input_value2, input_value3):
    if input_value3 < 1 or input_value3 > 51 :
        input_value3 = 1
    ...
    return generate_table(df_table, max_rows= input_value3)
